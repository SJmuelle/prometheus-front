...
export const environment = {
    ...
    urlApi: 'http://demo.fintra.co:8084/api-pqrs/api',
    urlApi2: 'http://demo.fintra.co:8084/api-pqrs/api/generic/qry/',
    urlApi3: 'http://demo.fintra.co:8084/api-pqrs/api/generic',
    ...
    adjunto: 'http://demo.fintra.co:8084/api-pqrs/api/pqrs',
