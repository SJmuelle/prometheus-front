...
@Component({
  selector: 'app-ref-titular-pn',
  templateUrl: './ref-titular-pn.component.html',
  styleUrls: ['./ref-titular-pn.component.scss']
})
export class RefTitularPnComponent implements OnInit {
