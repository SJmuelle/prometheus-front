...
@Component({
  selector: 'app-historico-politicas',
  templateUrl: './historico-politicas.component.html',
  styleUrls: ['./historico-politicas.component.scss']
})

export class HistoricoPoliticasComponent implements OnInit {
