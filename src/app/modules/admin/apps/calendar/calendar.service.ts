...
export class CalendarService {
            ...
            switchMap(response => this._events.pipe(
                ...
                map((events) => {
                    ...
                    for (const iterator of response.data) {
                        datos2 = {
                            allDay: true,
                            calendarId:  iterator.duration=='h'?"5dab5f7b-757a-4467-ace1-305fe07b11fe":"1a470c8e-40ed-4c2d-b590-a4f1f6ead6cc",
                            description: "",
                            recurringEventId: null,
                            isFirstInstance: true,
                            end:  iterator.end+"T19:00:00.000Z",
                            id: 'id'+iterator.id,
                            recurrence: null,
                    ...
                    // Otherwise...
                        ...
                        this._events.next([...events, ...datos]);
                    }
                    return datos;
    ...
    reloadEvents(): Observable<CalendarEvent[]> {
        //  Get the events
         let annoI = this.start.format('yyyy')
         let mesI = this.start.format('MM');
...
// Get the events
        ...
        // return this.getEvents(this.start, this.end);
    }
    ...
    addEvent(data): Observable<any> {
        ...
        //     ))
        // );
        //  switchMap(events => this._Utility.postQuery('api/apps/calendar/event', {
