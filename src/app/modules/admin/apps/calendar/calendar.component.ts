...
import { FuseVerticalNavigationAppearance } from '../../../../../@fuse/components/navigation/navigation.types';
@Component({
    selector       : 'calendar',
...
export class CalendarComponent implements OnInit, AfterViewInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        this._fuseMediaWatcherService.onMediaChange$
            ...
            // const evento=this.diaEvento.locale('es');
    ...
    ngAfterViewInit(): void
    {
        ...
        this._fullCalendarApi.setOption('locale', 'es');
