...
export class ConsultaNegociacionesComponent implements OnInit {
  ...
  public tableOptions: IoptionTable[] = [
    ...
    { name: 'valorDtoDebdo', text: 'Valor descuento debido', typeField: 'text', pipeName: 'number', classTailwind: 'whitespace-pre' },
    { name: 'ixmAlNegociar', text: 'Interés por mora', typeField: 'text', pipeName: 'number', classTailwind: 'whitespace-pre' },
    { name: 'porcentajeDtoIxm', text: '% intereses', typeField: 'text', pipeName: 'percentage' },
    { name: 'valorDtoIxm', text: 'Valor descuento interés', typeField: 'text', pipeName: 'number', classTailwind: 'whitespace-pre' },
    ...
    { name: 'valorDtoGac', text: 'Valor dscto gasto cobranza', typeField: 'text', pipeName: 'number', classTailwind: 'whitespace-pre' },
