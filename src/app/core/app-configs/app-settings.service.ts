 ...
 */
    ...
    /**
    * @description: End-Point cobranza
    */
    ...
    public cobranza = {
        url: {
            ...
            refinanciacionBuscarCliente: EndPoints.uri('/generic/qry/refinanciacion-buscar-cliente'),
            refinanciacionCargarDetalleCartera: EndPoints.uri('/generic/qry/refinanciacion-cargar-detalle-cartera'),
