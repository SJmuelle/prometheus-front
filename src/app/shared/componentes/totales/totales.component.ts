...
export class TotalesComponent implements OnInit {
    ...
    changeCurrentTotalMovil(total){
        this.filter(total.unidad);
        total.seleccionado = true;
        this.currentTotalMobil = total;
    }
    ...
    estoySelecionado(total){
        return total.nombre_unidad_negocio = this.currentTotalMobil.nombre_unidad_negocio
    }
